...
urlpatterns = [
    ...
    path('client/update/<int:pk>', views.client_update, name="clientupdate"),
    path('client/delete/<int:pk>', views.client_delete, name="clientdelete"),
    ...
    path('metrics/update/<int:pk>', views.metrics_update, name="metricsupdate"),
